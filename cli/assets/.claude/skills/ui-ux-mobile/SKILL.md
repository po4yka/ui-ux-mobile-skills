...
```bash
python3 .claude/skills/ui-ux-mobile/scripts/search.py "<keyword>" --domain <domain> [-n <max_results>] [--platform <platform>] [--format <format>]
```
...
python3 .claude/skills/ui-ux-mobile/scripts/search.py "button" --domain component

# Multi-domain search
python3 .claude/skills/ui-ux-mobile/scripts/search.py "button animation" --domain component,animation
...
python3 .claude/skills/ui-ux-mobile/scripts/search.py "tablet layout" --domain responsive

# 2. Search navigation changes for larger screens
python3 .claude/skills/ui-ux-mobile/scripts/search.py "rail drawer" --domain navigation

# 3. Search adaptive components
python3 .claude/skills/ui-ux-mobile/scripts/search.py "list detail" --domain responsive

# 4. Search spacing for density
python3 .claude/skills/ui-ux-mobile/scripts/search.py "density" --domain spacing
```
...
python3 .claude/skills/ui-ux-mobile/scripts/search.py "progressive walkthrough" --domain onboarding

# 2. Search form validation for signup
python3 .claude/skills/ui-ux-mobile/scripts/search.py "email validation" --domain forms

# 3. Search loading states
python3 .claude/skills/ui-ux-mobile/scripts/search.py "skeleton progress" --domain loading

# 4. Search error handling
python3 .claude/skills/ui-ux-mobile/scripts/search.py "network error" --domain errors
```
...
python3 .claude/skills/ui-ux-mobile/scripts/search.py "semantic primitive" --domain tokens

# 2. Search spacing system
python3 .claude/skills/ui-ux-mobile/scripts/search.py "baseline grid" --domain spacing

# 3. Search color tokens
python3 .claude/skills/ui-ux-mobile/scripts/search.py "color role" --domain tokens

# 4. Search typography tokens
python3 .claude/skills/ui-ux-mobile/scripts/search.py "typography scale" --domain tokens
```
